...
class Rectangle(Base):
    ...
    @property
    def x(self):
        """This sets the x coordinate of the Rectangle."""
        return self.__x
    ...
    def area(self):
        """This retuns the area of the Rectangle."""
    ...
    def __str__(self):
        """This return the print() and str() rep of the Rectangle."""
